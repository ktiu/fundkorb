---
beschreibung:
  wissenschaftlich: Hemimycena gracilis
  deutsch: Nadel-Scheinhelmling
  referenz: (Quél.) Singer 1943
  synonym: "Synonym: Hemimycena pithya"
...
hauptbild:
  anzeige: false
  datei: /bilder/hemimycena_gracilis_02_md.jpg
literatur:
  - text: "Breitenbach & Kränzlin: Pilze der Schweiz, Band 3, Nr. 219 (als
      Hemimycena pithya)"
  - text: "German J. Krieglsteiner (Hrsg.): Die Großpilze Baden-Württembergs, Band
      3, Seite 255"
  - text: "Meinhard Moser: Kleine Kryptogamenflora Band IIb/2, Seite 165 - 167"
  - text: "Rudolf Winkler / Gaby Keller: Pilze Mitteleuropas, Seite 354, (5.20.101)"
---
Der Nadel-Scheinhelmling gehört mit Hutdurchmessern von 3 – 10 Millimetern zu den kleinsten Arten der Gattung, die nicht leicht auseinanderzuhalten sind. Er gehört zu denen, die gern auf Fichtennadeln wachsen, wodurch sich die Anzahl der in Frage kommenden Arten reduziert. Die Hütchen sind halbkugelig bis glockig, erst im Alter flach werdend. Sie haben auffallend wenige bis zum Stiel reichende Lamellen (meist 10 – 15) mit meist einer verkürzten Lamelette in den Zwischenräumen. Die sehr dünnen, glatten Stiele werden maximal 6 cm lang, aber höchstens 1 Millimeter dick, an der Basis mit weißem [Myzelfilz](Myzel "Glossar"). Wir haben es mit einem zumindest im südlichen Deutschland oder in höheren Lagen häufigeren Scheinhelmling zu tun.

Bestimmung nach *Moser*: 
Kleine Art, also weiter bei: 6 Hut und Stiel unter der Lupe nicht erkennbar behaart, weiter bei: 13 da auf Nadeln weiter bei: 15 da im Fichtenwald = *Hemimycena gracilis*. Falls auf Kiefernnadeln = *Hemimycena pseudogracilis*, seltene Art). Daraus lässt sich die Merkmalskombination 
