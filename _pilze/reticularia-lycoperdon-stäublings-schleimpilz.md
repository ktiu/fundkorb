...
{% include bild.html datei="/bilder/reticularia_lycoperdon_04_uw.jpeg" %}
{% include abbildung_ende.html legende="(Foto links: Frank Kaster) -- Foto rechts: kurz vor dem Aufplatzen (Ulrike Wegner)" %}
