---
beschreibung:
  wissenschaftlich: Hemimycena cucullata
  deutsch: Gipsweißer Scheinhelmling
  referenz: (Pers.) Singer 1961
  erlaeuterung: cucullata = mit Kappe, Kapuze
  familie: Mycenaceae
profil:
...
hauptbild:
  anzeige: false
  datei: /bilder/hemimycena_cucullata_02_mb.jpg
literatur:
  - text: "Breitenbach & Kränzlin: Pilze der Schweiz, Band 3, Nr. 216"
  - text: "German J. Krieglsteiner (Hrsg.): Die Großpilze Baden-Württembergs, Band
      3, Seite 253 – 254"
  - text: "Ewald Gerhardt: Der große BLV Pilzführer für unterwegs, Seite 196"
  - text: "Rudolf Winkler / Gaby Keller: Pilze Mitteleuropas, Seite 355, (5.20.104)"
---
{% include abbildung_start.html stil="mittel" %}
{% include bild.html datei="/bilder/hemimycena_cucullata_01_cw.jpg" %}
...
{% include abbildung_start.html stil="mittel" %}
{% include bild.html datei="/bilder/hemimycena_cucullata_02_mb.jpg" nocrop=true %}
