---
beschreibung:
  wissenschaftlich: Lactarius aspideus
  deutsch: Blasser Violett-Milchling
  referenz: (Fr.) Fr. 1838
  synonym: "Synonym: Lactifluus aspideus"
  erlaeuterung: aspideus = schildartig
  familie: Russulaceae
profil:
...
hauptbild:
  anzeige: false
  datei: /bilder/lactarius_aspideus_01_bw.jpg
literatur:
  - text: "Jacob Heilmann-Clausen, Annemieke Verbeken & Jan Vesterholt: The genus
      Lactarius, Seite 96 - 97"
  - text: "German J. Krieglsteiner (Hrsg.): Die Großpilze Baden-Württembergs, Band
      2, Seite 363"
  - text: "Karin Montag: Der Tintling, Heft 56, Pilzportät Nr. 100"
  - text: "Michael - Hennig - Kreisel: Handbuch für Pilzfreunde Band V, Nr. 14a,
      Seite 150"
  - text: "Svengunnar Ryman / Ingmar Holmåsen: Pilze, Seite 559"
  - text: "Rose-Marie & Sabine Maria Dähncke: 700 Pilze in Farbfotos, Seite 526"
  - text: "Rudolf Winkler / Gaby Keller: Pilze Mitteleuropas, Seite 758 (15.2.15)"
  - url: https://de.wikipedia.org/wiki/Blasser_Violett-Milchling
---
...
{% include abbildung_start.html stil="mittel" %}
{% include bild.html datei="/bilder/lactarius_aspideus_04_uwi.jpg" nocrop=true %}
{% include bild.html datei="/bilder/lactarius_aspideus_05_wi.jpg" nocrop=true %}
{% include abbildung_ende.html legende="Foto links: Uwe Winkler, bei St. Blasien im Schwarzwald -- Abbildung rechts: Wikipedia, J. E. Lange, gemeinfrei (Flora agaricina Danica)" %}
