---
beschreibung:
  wissenschaftlich: Gymnosporangium clavariiforme
  deutsch: Weißdorn-Gitterrrost
  referenz: "(Wulfen) DC. 1802 - Familie: Pucciniceae"
  erlaeuterung: clavariiforme = keulenpilzförmig
...
hauptbild:
  anzeige: false
  datei: /bilder/gymnosporangum_clavariiforme_01_wi.jpg
literatur:
  - text: "Svengunnar Ryman / Ingmar Holmåsen: Pilze, Seite 71"
  - url: https://www.arbofux.de/weissdorn-gitterrost.html
  - text: ""
    url: https://www.cecidologie.de/cpg16x/displayimage.php?pid=1194
---
{% include abbildung_start.html stil="fliessend" %}
{% include bild.html datei="/bilder/gymnosporangum_clavariiforme_01_wi.jpg" %}
{% include abbildung_ende.html legende="Gymnosporangium clvariiforme an Wacholder (Foto: Wikipedia by Velella – Own Work CC BY-SA 3.0)" %}
...
{% include bild.html datei="/bilder/gymnosporangum_clavariiforme_02_tlo.png" nocrop=true %}
{% include bild.html datei="/bilder/gymnosporangum_clavariiforme_03_tlo.png" nocrop=true %}
{% include abbildung_ende.html legende="Gymnosporangium clvariiforme an Weißdorn (2 Fotos: Thomas Lohrer)" %}
