---
beschreibung:
  wissenschaftlich: Pholiota spumosa
  deutsch: Nadel-Schüppling
  referenz: (Fr.) Singer 1948
  erlaeuterung: spumosa = schäumend
...
hauptbild:
  anzeige: true
  datei: /bilder/pholiota_spumosa_01_md.jpg
  legende: Alle Fotos von Matthias Dondl
literatur:
  - text: "Breitenbach & Kränzlin: Pilze der Schweiz, Band 4, Nr. 439"
  - text: "German J. Krieglsteiner (Hrsg.): Die Großpilze Baden-Württembergs, Band
      4, Seite 390 - 391"
  - text: "Ewald Gerhardt: Der große BLV-Führer für unterwegs, Seite 338"
  - text: "Rose Marie & Sabine Maria Dähncke: 700 Pilze in Farbfotos,  Seite 366"
  - text: "Rudolf Winkler / Gaby Keller: Pilze Mitteleuropas, Seite 522 (11.3.17)"
---
...
{% include bild.html datei="/bilder/pholiota_spumosa_03_md.jpg" nocrop=true %}
{% include bild.html datei="/bilder/pholiota_spumosa_04_md.jpg" nocrop=true %}
{% include abbildung_ende.html legende="Foto links mit aufgeschnittenen Fruchtkörpern - - rechts: Sporen" %}
