---
beschreibung:
  wissenschaftlich: Mycena fagetorum
  deutsch: Buchen-Helmling
  referenz: (Fr.) Gillet 1876
  familie: Mycenaceae
  erlaeuterung: fagetorum = in Buchenwäldern
profil:
  aktualisiert: 2026-09-26
  autor_in: Dieter Gewalt
hauptbild:
  anzeige: false
  datei: /bilder/mycena_fagetorum_01_md.jpg
literatur:
  - text: "Erhard Ludwig: Pilzkompendium Band 3, Nr. 116/103, Seite 744"
...
{% include bild.html datei="/bilder/mycena_fagetorum_02_md.jpg" nocrop=true %}
{% include bild.html datei="/bilder/mycena_fagetorum_03_md.jpg" nocrop=true %}
{% include abbildung_ende.html legende="Mikrofoto rechts: Sporen in Kongorot" %}

Die graubräunlichen, jung stumpf kegeligen, später abgeflachten aufhellenden Hüte erreichen Durchmesser von 1 - 3 cm. Sie sind auffallend bis fast zur dunkleren Mitte gestreift, wobei die Streifen das Muster der Lamellen abbilden. Die meist blass rosafarbenen, seltener graubräunlichen, schmalen Lamellen sind mit einem Zähnchen am Stiel angewachsen, das sich im Alter halsbandartig ablöst. Ein markantes Merkmal sind die Stiele, die oft (aber nicht immer!) an ihrer Basis knieartig geknickt sind und dem Pilz zu dem daher auch irreführenden Namen *„Geknickter Helmling“* verholfen haben. Die Stielbasis kann weißstriegelig bekleidet sein. Das extrem dünne Fleisch ist geruchlos oder leicht mehlig bis rettichartig. Das Sporenpulver ist weiß.

Mikromerkmale: siehe Anhang

*Mycena fagetorum* muss als seltene Art gelten, die bevorzugt auf faulenden Buchenblättern wächst und dann oft sogar in größerer Anzahl erscheint. Erscheinungszeit ist September bis Dezember, die Art ist aber auch schon im Mai gefunden worden. 

- - -

#### Anhang: Beschreibung des abgebildeten Fundes von Matthias Dondl

Mit Gröger geschlüsselt. Im Feld besteht Verwechslungsgefahr mit M. flavescens, die aber viel stärker nach Radi riecht und auch im Habitus etwas anders ist. Mikroskopisch sind die sehr schlanken Sporen sehr auffällig. 
