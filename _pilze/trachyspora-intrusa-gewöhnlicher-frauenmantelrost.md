---
beschreibung:
  wissenschaftlich: Trachyspora intrusa
  deutsch: Gewöhnlicher Frauenmantelrost
  referenz: (Grev.) Arthur 1934
  synonym: "Synonym: Trachyspora alchemillae"
  erlaeuterung: intrusa = eingeträngt
  familie: Glomeridae
profil:
...
hauptbild:
  anzeige: false
  datei: /bilder/trachyspora_intrusa_03_bm.jpeg
literatur:
  - text: "Julia Kruse: Faszinierende Pflanzenpilze – Erkennen und Bestimmen"
  - url: https://www.pilzkunde.de/index.php/miscellanea-fachfremdes/garten-als-lebensraum/pilze-beitrag-noch-leer/pilze-3-parasitische-pilze
---
{% include abbildung_start.html stil="klein" %}
{% include bild.html datei="/bilder/trachyspora_intrusa_01_bm.jpeg" nocrop=true %}
{% include bild.html datei="/bilder/trachyspora_intrusa_02_bm.jpeg" nocrop=true %}
{% include bild.html datei="/bilder/trachyspora_intrusa_03_bm.jpeg" nocrop=true %}
