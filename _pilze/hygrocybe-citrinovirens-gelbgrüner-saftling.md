---
beschreibung:
  wissenschaftlich: Hygrocybe citrinovirens
  deutsch: Gelbgrüner Saftling
  referenz: (J.E. Lange) Schäff. 1947
  erlaeuterung: citrinovirens = gelbgrünlich
...
literatur:
  - text: "German J. Krieglsteiner (Hrsg): Die Großpilze Baden-Württembergs Band 3,
      Seite 45"
  - text: "Rudolf Winkler, Gaby Keller: Pilze Mitteleuropas, Seite 197 (4.1.23)"
  - url: https://en.wikipedia.org/wiki/Hygrocybe_citrinovirens
---
{% include abbildung_start.html stil="fliessend" %}
{% include bild.html datei="/bilder/hygrocybe_citrinovirens_01_tl.jpg" %}
