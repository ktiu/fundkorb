---
beschreibung:
  wissenschaftlich: Hypholoma elongatum
  deutsch: Torfmoos-Schwefelkopf
  referenz: (Pers.) Ricken 1915
  synonym: "Synonym: Hypholoma elongatipes"
  erlaeuterung: elongatum = verlängert, gestreckt
...
hauptbild:
  anzeige: false
  datei: /bilder/hypholoma_elongatum_02_md.jpg
literatur:
  - text: "Breitenbach & Kränzlin: Pilze der Schweiz, Band 4, Nr. 409"
  - text: "German J. Krieglsteiner (Hrsg.): Die Großpilze Baden-Württembergs, Band
      4, Seite 354 – 355"
  - text: "Ewald Gerhardt: Der große BLV Pilzführer für unterwegs, Seite 346"
  - text: "Rudolf Winkler / Gaby Keller: Pilze Mitteleuropas, Seite 511 (11.1.06)"
---
{% include abbildung_start.html stil="mittel" %}
{% include bild.html datei="/bilder/hypholoma_elongatum_01_md.jpg" %}
...
{% include bild.html datei="/bilder/hypholoma_elongatum_02_md.jpg" nocrop=true %}
{% include bild.html datei="/bilder/hypholoma_elongatum_03_md.jpg" nocrop=true %}
{% include bild.html datei="/bilder/hypholoma_elongatum_04_md.jpg" nocrop=true %}
