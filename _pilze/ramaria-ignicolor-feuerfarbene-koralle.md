---
beschreibung:
  wissenschaftlich: Ramaria ignicolor
  deutsch: Feuerfarbene Koralle
  referenz: Corner 1950
  erlaeuterung: ignicolor = feuerfarbig
  familie: Gomphaceae
profil:
...
hauptbild:
  anzeige: false
  datei: /bilder/ramaria_ignicolor_01_aeh.jpg
literatur:
  - text: "Josef Christan: Die Gattung Ramaria in Deutschland, Seite 212-213"
  - text: "Hermann Jahn: Erfahrungen mit schönfarbigen Korallen (Ramaria) in
      Kalkbuchenwäldern – Myk. Mitteilungsblatt, Jg. 28 (1), Seite 9 - 19"
...
Die Fruchtkörper der Feuerfarbenen Koralle (*Ramaria ignicolor*) sind nicht groß, wirken aber bei näherem Hinsehen durch ihr Farbspiel sehr apart. Bei dieser Koralle kann man verstehen, dass *Hermann Jahn* von „schönfarbigen Korallen“ spricht. Diese sehr seltene Art benötigt Kalkboden und geht eine [Mykorrhiza](Mykorrhiza "Glossar") mit Nadelbäumen wie Fichten und Weißtannen ein. Die hier gezeigten Fruchtkörper wurden Anfang September 2025 in einem Bergnadelwald nahe Dottenweiler im Mittleren Schwarzwald während einer Pilzexkursion des Mykologischen Arbeitskreises Hornberg aufgesammelt und fotografiert.
