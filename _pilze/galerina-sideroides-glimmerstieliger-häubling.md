---
beschreibung:
  wissenschaftlich: Galerina sideroides
  deutsch: Glimmerstieliger Häubling
  referenz: (Bull.) Kühner 1935
  erlaeuterung: sideroides = eisenähnlich
...
{% include bild.html datei="/bilder/galerina_sideroides_02_md.jpg" nocrop=true %}
...
{% include abbildung_start.html stil="mittel" %}
{% include bild.html datei="/bilder/galerina_sideroides_03_jfe.jpg" %}
{% include abbildung_ende.html legende="Cheilozystiden (links oben und unten) und Sporen (rechts oben)" %}
