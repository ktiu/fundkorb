---
beschreibung:
  wissenschaftlich: Pholiota lucifera
  deutsch: Fettiger Schüppling
  referenz: (Lasch) Quél. 1872
  erlaeuterung: lucifera = leuchtfarbig
...
hauptbild:
  anzeige: false
  datei: /bilder/pholiota_lucifera_02_md.jpg
literatur:
  - text: "Breitenbach & Kränzlin: Pilze der Schweiz, Band 4, Nr. 433"
  - text: "German J. Krieglsteiner (Hrsg.): Die Großpilze Baden-Württembergs, Band
      4, Seite 385 - 386"
  - text: "Rudolf Winkler / Gaby Keller: Pilze Mitteleuropas, Seite 520 (11.3.12)"
---
{% include abbildung_start.html stil="standard" %}
{% include bild.html datei="/bilder/pholiota_lucifera_01_md.jpg" %}
...
{% include bild.html datei="/bilder/pholiota_lucifera_03_md.jpg" %}
{% include abbildung_ende.html legende="Mikrofoto: Cheilozystiden und vereinzelte Sporen" %}
