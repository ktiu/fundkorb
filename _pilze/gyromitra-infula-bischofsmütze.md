...
{% include abbildung_start.html stil="mittel" %}
{% include bild.html datei="/bilder/gyromitra_infula_05_uw.jpg" %}
{% include abbildung_ende.html legende="Es kann sich lohnen, auch nachts nach Pilzen zu suchen (Foto: Ulrike Wegner)" %}
