---
beschreibung:
  wissenschaftlich: Boletus lupinus
  deutsch: Wolfs-Röhrling
  referenz: (Fr.) Costanzo, Gelardi, Simonini & Vizzini 2015
  synonym: "Neuer Name: Rubroboletus lupinus"
  erlaeuterung: lupinus = wölfisch, wolfsartig
...
hauptbild:
  anzeige: false
  datei: /bilder/boletus_lupinus_03_uwi.jpg
literatur:
  - text: "Dämmrich et al. (2016): Rote Liste der Großpilze und vorläufige
      ...
      Ascomycota) Deutschlands, Seite 52 "
  - text: "J. A. Munos: Bletus s. l. Fungi Europaei Vol. 2, Seite 404 - 407"
  - text: "German J. Krieglsteiner (Hrsg.): Die Großpilze Baden-Württembergs, Band
      2, Seite 215 – 216"
  - text: "Ewald Gerhardt: Der große Pilzführer für unterwegs, Seite 470"
  - text: "Rudolf Winkler / Gaby Keller: Pilze Mitteleuropas, Seite 160 (3.2.25)"
  - url: https://de.wikipedia.org/wiki/Rubroboletus
  - url: https://de.wikipedia.org/wiki/Wolfs-R%C3%B6hrling
---
{% include abbildung_start.html stil="standard" %}
{% include bild.html datei="/bilder/boletus_lupinus_03_uwi.jpg" %}
{% include abbildung_ende.html legende="3 Fotos: Uwe Winkler" %}

Im Herbst 2022 fand Pilzfreund *Uwe Winkler* in Kroation-Istrien bei Umag eine eindrucksvolle Kollektion des Wolfsröhrlings. Es handelt sich um eine wärmeliebende Art, die in kleinen Gruppen im Spätsommer und Herbst in Laubwäldern vor allem bei Kastanien und Eichen fruktifiziert, vorzugsweise auf basenreichen Böden. Typisch sind mediterrane Standorte. Man findet die Art oft vergesellschaftet mit dem [Satans-Röhrling Boletus satanas](/pilze/boletus-satanas-satansröhrling) und dem [Netzstieligen Hexenröhrling Boletus luridus](/pilze/boletus-luridus-netzstieliger-hexenröhrling). In Deutschland ist ist der Wolfsröhrling extrem selten. Die DGfM-Verbreitungskarte weist gerade mal 8 Fundmeldungen aus.

{% include abbildung_start.html stil="mittel" %}
{% include bild.html datei="/bilder/boletus_lupinus_02_uwi.jpg" %}
{% include bild.html datei="/bilder/boletus_lupinus_01_uwi.jpg" %}
{% include abbildung_ende.html %}

Der Wolfsröhrling gehört zur neuen, relativ kleinen Gattung der Purpurröhrlinge (*Rubroboletus*), deren gemeinsame Kennzeichen sich wie folgt beschreiben lassen: rötliche Hutoberfläche, orange-rote bis blutrote Poren, gelbe Röhren, Stieloberfläche oft mit gelben Farbtönen, rosafarbenem bis rotem Netz oder ebenso gefärbten Punkten/Flocken und blauer Fleischverfärbung bei Verletzung. Verwechselt werden könnte er u. a. mit dem etwas häufigeren, meist schlankeren [Glattstieligen Hexenröhrling Boletus queletii](/pilze/boletus-queletii-glattstieliger-hexenröhrling) mit  meist dunkleren, ins Bräunliche gehenden Hutfarben. Außerdem ist sein Fleisch in der Stielbasis deutlich weinrot bis purpurfarben und besitzt eine positive Amyloid-Reaktion.

Der Wolfsröhrling gilt als giftverdächtig und sollte aufgrund seiner Seltenheit unbedingt geschont werden.

{% include abbildung_start.html stil="standard" %}
{% include bild.html datei="/bilder/boletus_lupinus_04_wi.jpg" %}
{% include abbildung_ende.html legende="Foto: Wikipedia -  Bernypisa, Boletus lupinus2, CC BY-SA 3.0" %}
